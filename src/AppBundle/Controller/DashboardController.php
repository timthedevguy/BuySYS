...
class DashboardController extends Controller {
	...
	public function indexAction(Request $request)
	{
		...
		$pendingIncome = $em->getRepository('AppBundle:TransactionEntity')->getBalanceForUserWithStatus($this->getUser());
		$actualIncome = $em->getRepository('AppBundle:TransactionEntity')->getBalanceForUserWithStatus($this->getUser(), 'Complete');
